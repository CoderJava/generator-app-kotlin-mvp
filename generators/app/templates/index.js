...
module.exports = class extends Generator {
    ...
    writingFunction() {
        ...
        this.fs.copy(appPath + 'versions.gradle', 'versions.gradle');
        ...
        this.fs.copyTpl(appPath + 'app/src/androidTest/java/com/ysn/basekotlinmvp', 'app/src/androidTest/java/' + packageDir, this.props);
        this.fs.copyTpl(appPath + 'app/src/main/AndroidManifest.xml', 'app/src/main/AndroidManifest.xml', this.props);
        this.fs.copyTpl(appPath + 'app/src/main/java/com/ysn/basekotlinmvp', 'app/src/main/java/' + packageDir, this.props);
        this.fs.copyTpl(appPath + 'app/src/main/res/layout/', 'app/src/main/res/layout', this.props);
        this.fs.copyTpl(appPath + 'app/src/test/java/com/ysn/basekotlinmvp', 'app/src/test/java/' + packageDir, this.props);
    }
};